export interface ServiceConfig {
  ...
  envVars?: { key: string; description: string; default?: string; required?: boolean }[];
  healthCheck?: string;
  dependsOn?: string[];
  description: string;
...
export const BUNDLES: Record<string, { name: string; description: string; services: string[] }> = {
  'media-stack': {
    name: '🎬 Media Stack',
